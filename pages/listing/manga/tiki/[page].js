...
export async function getStaticProps({ params }) {
    ...
    const res = await fetch(`https://tiki.vn/api/personalish/v1/blocks/listings?limit=24&category=1084&page=${params.page}&sort=newest&seller=1&urlKey=truyen-tranh`, {
        headers: {
