...
const pageDescription =
  "Xem manga mới phát hành chưa bao giờ là dễ hơn, nay được tổng hợp từ nhiều trang TMDT khác nhau!";
...
function Fahasa({ index }) {
  const { data, error } = useSWR(
    `https://cdn0.fahasa.com/fahasa_catalog/product/loadproducts?category_id=6718&currentPage=${index}&limit=24&order=created_at&series_type=0`,
    (url) =>
      fetcher(url, {
        headers: {
          "User-Agent":
