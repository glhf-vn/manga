...
function Tiki({ index }) {
    const { data, error } = useSWR(`https://tiki.vn/api/personalish/v1/blocks/listings?limit=24&category=7358&page=${index}&sort=newest&seller=1&urlKey=light-novel`, url => fetcher(url, {
        headers: {
...
export default function TikiLightNovelListing() {
