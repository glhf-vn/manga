...
export async function getStaticProps({ params }) {
    ...
    const res = await fetch(`https://tiki.vn/api/personalish/v1/blocks/listings?limit=24&category=7358&page=${params.page}&sort=newest&seller=1&urlKey=truyen-tranh`, {
        headers: {
    ...
    return (
        <Layout title={pageTitle} description={pageDescription}>
            <div className={`uk-container ${styles.main}`}>
                <h1 className={`uk-heading-line uk-margin-medium ${styles.title}`}><span>Light-novel Mới - Tiki Trading</span></h1>
                ...
                <ul className="uk-pagination uk-flex-center">
                    {params.page > 1 ? <li><a href={(Number(params.page) - 1)}><span uk-pagination-previous="true"></span></a></li> : <li className='uk-disabled'><a><span uk-pagination-previous="true"></span></a></li>}
                    ...
                    {params.page < 10 ? <li><a href={(Number(params.page) + 1)}><span uk-pagination-next="true"></span></a></li> : <li className='uk-disabled'><a><span uk-pagination-next="true"></span></a></li>}
                </ul>
            </div>
        </Layout >
    )
