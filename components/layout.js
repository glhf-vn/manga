            ...
            <footer className={footer.wrapper}>
                <div className="uk-container">
                    <div className={footer.copyright}>
                        <span>
                            <a href="//facebook.com/Catouberos" target="_blank" title="Đi đến Facebook" rel='noreferrer'>Catou</a>
                            {' '} © {currentYear}
                        </span>
                    </div>
                    <div className={footer.contact}>
                        ...
                        <a className="uk-margin-left" title="Facebook" href="//fb.com/mangaGLHF" target="_blank" rel='noreferrer'>
