  ...
  return (
    <div>
      <Head>
        ...
        <meta
          name="keywords"
          content="lịch phát hành, manga, comics, anime, truyện tranh"
        />
      ...
      <div uk-sticky="sel-target: .uk-navbar-container; cls-active: uk-navbar-sticky">
        <nav className="uk-navbar-container" uk-navbar="true">
          <ul className={`${nav.wrapper} uk-navbar-nav uk-margin-auto`}>
            ...
            <li
              className={
                router.pathname == ("/license" || "/vote") ? "uk-active" : ""
              }
            >
              <a href="#">Bản quyền</a>
              <div className="uk-navbar-dropdown">
                <ul className="uk-nav uk-navbar-dropdown-nav">
                  <li
                    className={router.pathname == "/license" ? "uk-active" : ""}
                  >
            ...
            <li
              className={router.pathname.includes("listing") ? "uk-active" : ""}
            >
              <a href="#">Truyện mới</a>
              <div className="uk-navbar-dropdown">
                <ul className="uk-nav uk-navbar-dropdown-nav">
                  ...
                  <li
                    className={
                      router.pathname.includes("/listing/manga/tiki")
                        ? "uk-active"
                        : ""
                    }
                  >
                  ...
                  <li
                    className={
                      router.pathname == "/listing/manga/fahasa"
                        ? "uk-active"
                        : ""
                    }
                  >
                  ...
                  <li
                    className={
                      router.pathname.includes("/listing/light-novel/tiki")
                        ? "uk-active"
                        : ""
                    }
                  >
                  ...
                  <li
                    className={
                      router.pathname == "/listing/light-novel/fahasa"
                        ? "uk-active"
                        : ""
                    }
                  >
        ...
        >
          ...
          <div className="uk-inline">
            <button
              ...
              style={{ background: "#81BC41", border: "none" }}
            >
              Chuyển khoản
            </button>
            <div uk-drop="mode: hover; delay-hide: 0">
              <Image
                ...
                height={993}
                layout="responsive"
                alt="Chuyển khoản (Vietcombank)"
                src="/img/vietcombank.jpg"
              />
            </div>
          </div>
          <div className="uk-inline">
          ...
          <div className="uk-inline">
            <button
              ...
              id="momo"
              className="uk-button uk-button-secondary uk-margin-small-top uk-margin-small-right"
              style={{ background: "#a50064", border: "none" }}
            >
              MoMo
            </button>
            <div uk-drop="mode: hover; delay-hide: 0">
          ...
          <button
            id="paypal"
            href="https://paypal.me/tottidkn"
            target="_parent"
            className="uk-button uk-button-secondary uk-margin-small-top uk-margin-small-right"
            style={{ background: "#0070ba", border: "none" }}
          >
            PayPal
          </button>
        </div>
      ...
      <footer className={footer.wrapper}>
        <div className="uk-container">
          ...
          <div className={footer.contact}>
            <a title="Gửi e-mail" href="mailto:konnichiwa@glhf.vn">
              Liên hệ
            </a>
            <Link href="/oss" scroll={false}>
              <a className="uk-margin-left">OSS Licenses</a>
            </Link>
            <a
              className="uk-margin-left"
              title="GitHub"
              href="//github.com/catouberos/mangaGLHF"
              target="_blank"
              rel="noreferrer"
            >
              <svg
